...
|--------------------------------------------------------------------------
*/
export async function getAllUsers(db, search) {
    const prisma = createPrisma(db);
...
export async function getUserDetails(db, userId) {
    const prisma = createPrisma(db);
...
export async function updateUserStatus(db, userId, status, adminId) {
    const prisma = createPrisma(db);
...
export async function updateUserRole(db, userId, role, adminId) {
    const prisma = createPrisma(db);
    await prisma.user.update({
        where: { id: userId },
        data: { role },
...
|--------------------------------------------------------------------------
*/
export async function addBonus(db, userId, amount, type, reason, adminId) {
    const prisma = createPrisma(db);
...
|--------------------------------------------------------------------------
*/
export async function releaseUserFunds(db, userId, releaseBonus, releaseRewards, txHash, adminId, notes) {
    const prisma = createPrisma(db);
    const user = await prisma.user.findUnique({
        where: { id: userId },
        select: {
...
export async function getReleaseHistory(db) {
    const prisma = createPrisma(db);
...
export async function updateSetting(db, key, value, adminId) {
    const prisma = createPrisma(db);
...
|--------------------------------------------------------------------------
*/
export async function getAllPurchases(db) {
    const prisma = createPrisma(db);
...
export async function getAllRewards(db) {
    const prisma = createPrisma(db);
